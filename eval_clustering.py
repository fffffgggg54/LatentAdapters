...
file_path = out_dir + "Pairwise Pearson Correlation Coefficient of Adapted Embeds (mscoco).png"
#file_path = out_dir + "Pairwise Pearson Correlation Coefficient of Latents (mscoco).png"
