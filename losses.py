...
def pairwise_adapter_loss_with_discriminator(adapter, discriminator, embeds, latent_aug_str = 0.6, self_mse=1, pw_mse=1, cycle_mse=1, latent_mse=10, dc_ce=0.0, loss_fn = MSE, zsl_idxs = None):
