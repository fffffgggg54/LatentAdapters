...
def pairwise_adapter_loss_with_discriminator(adapter, discriminator, embeds, self_mse=1, pw_mse=1, cycle_mse=1, latent_mse=1, dc_ce=1, loss_fn = norm_MSE_variance):
